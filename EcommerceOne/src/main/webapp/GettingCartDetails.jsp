...
<body>
	 <%
    	List<ProductDetails> ll = CartDao.getProductDetails();
	...
	<table id="customers">
  	...
  	<tr>
    	...
    	<td><button><a href ="Order.jsp?name=${information.getProductName()}">Order</a></button></td>
    	<td><button><a href ="Delete.jsp?name=${information.getProductName()}">Remove</button></td>
  	</tr>
  </c:forEach>	
  </table>
